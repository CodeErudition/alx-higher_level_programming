#!/usr/bin/python3
"""
This module defines a Class Rectangle unit tests.
"""
import unittest
...
class TestRectangle(unittest.TestCase):
    ...
    def test_Rectangle_constructor_no_args(self):
    ...
    def test_Rectangle_constructor_many_args(self):
        """Tests constructor signature."""
        with self.assertRaises(TypeError) as e:
    ...
    def test_Rectangle_constructor_one_args(self):
        """Tests constructor signature."""
        with self.assertRaises(TypeError) as e:
            r = Rectangle(1)
    ...
    def test_Rectangle_instantiation_positional(self):
    ...
    def test_Rectangle_instantiation_keyword(self):
        """Tests positional instantiation."""
    ...
    def test_Rectangle_id_inherited(self):
    ...
    def invalid_types(self):
        ...
        in_types = (3.14, -1.1, float('inf'), float('-inf'), True, "str", (2,),
                [4], {5}, {6: 7}, None)
        return in_types

    def test_Rectangle_validate_type(self):
    ...
    def test_Rectangle_validate_value_negative_gt(self):
        """Tests property validation."""
        r = Rectangle(1, 2)
        attrs = ["width", "height"]
        for attr in attrs:
    ...
    def test_Rectangle_validate_value_negative_ge(self):
        """Tests property validation."""
        r = Rectangle(1, 2)
        attrs = ["x", "y"]
        for attr in attrs:
    ...
    def test_Rectangle_validate_value_zero(self):
        """Tests property validation."""
        r = Rectangle(1, 2)
        attrs = ["width", "height"]
        for attr in attrs:
    ...
    def test_Rectangle_property_range_zero(self):
        """Tests property setting/getting."""
        r = Rectangle(1, 2)
        r.x = 0
        r.y = 0
    ...
    def test_Rectangle_area_no_args(self):
    ...
    def test_Rectangle_display_no_args(self):
    ...
    def test_Rectangle_display_simple(self):
    ...
    def test_Rectangle_str_no_args(self):
    ...
    def test_LRectangle_update_no_args(self):
    ...
    def test_Rectangle_update_args_bad(self):
    ...
    def test_Rectangle_update_kwargs_2(self):
        """Tests update() keyword args."""
        r = Rectangle(5, 2)
        d = r.__dict__.copy()
